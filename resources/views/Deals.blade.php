    ...
    <div class="absolute inset-0 flex flex-col justify-center items-start p-8 sm:p-12 lg:p-24">
        <div class="max-w-md text-white">
            ...
            <div class="flex flex-col items-start gap-0">
                ...
                <h1 class="text-3xl sm:text-4xl font-[poppins] font-bold text-white text-nowrap">Rp 12.999.000</h1>
                <h2 class="text-xl sm:text-2xl font-[poppins] text-gray-400 line-through text-nowrap -mt-5"><br>Rp 16.350.649</br></h2>
            </div>
...
<section class="relative w-full">
    ...
    <div class="absolute inset-0 flex flex-col justify-center items-start p-8 sm:p-12 lg:p-24">
        <div class="max-w-md text-white">
            ...
            <div class="flex flex-col items-start gap-0">
                ...
                <h1 class="text-3xl sm:text-4xl font-[poppins] font-bold text-white text-nowrap">Rp 14.500.000</h1>
                <h2 class="text-xl sm:text-2xl font-[poppins] text-gray-400 line-through text-nowrap -mt-5"><br>Rp 16.843.496</br></h2>
            </div>
    ...
    <div class="absolute bottom-0 right-0 p-8 sm:p-12 lg:p-24">
        <img src="{{ asset('image/Deals/amd-logo.png') }}" alt="Deals Banner" class="h-15 sm:h-20 w-auto">
    </div>
</section>
