...
<main>
  ...
  <div class="products" id="asus-products">
    ...
    <div class="product-card" data-aos="fade-up" data-aos-delay="200">
      ...
      <button class="buy-button" data-link="{{ route('product.detail', ['slug' => 'zenbook-a14']) }}">Buy</button>
  ...
  <div class="products" id="lenovo-products">
    <div class="product-card" data-aos="fade-up">
      ...
      <p>Up To 2TB M.2 NVMe™ Gen 4 Storage</p>
      <button class="buy-button" data-link="{{ route('product.detail', ['slug' => 'legion5-g10']) }}">Buy</button>
    ...
    <div class="product-card" data-aos="fade-up" data-aos-delay="100">
      ...
      <button class="buy-button" data-link="{{ route('product.detail', ['slug' => 'ideapad-5i']) }}">Buy</button>
    ...
    <div class="product-card" data-aos="fade-up" data-aos-delay="200">
      ...
      <p>1TB M.2 NVMe™ Gen 4 Storage</p>
      <button class="buy-button" data-link="{{ route('product.detail', ['slug' => 'thinkpad-t14']) }}">Buy</button>
  ...
  <div class="products" id="hp-products">
    <div class="product-card" data-aos="fade-up">
      ...
      <button class="buy-button" data-link="{{ route('product.detail', ['slug' => 'victus-15t']) }}">Buy</button>
    ...
    <div class="product-card" data-aos="fade-up" data-aos-delay="100">
      ...
      <p>1TB M.2 NVMe™ Storage</p>
      <button class="buy-button" data-link="{{ route('product.detail', ['slug' => 'pavilion-16t']) }}">Buy</button>
    ...
    <div class="product-card" data-aos="fade-up" data-aos-delay="200">
      ...
      <button class="buy-button" data-link="{{ route('product.detail', ['slug' => 'probook-460']) }}">Buy</button>
